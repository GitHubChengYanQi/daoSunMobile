          ...
          <Row gutter={24}>
            <Col span={16}>
              <Card.Header style={{ padding: 0 }}
                           title={<strong style={{ fontSize: 16 }}>道昕智造<Button size='small' type='link' onClick={() => {
                             router.push('/Work/Customer/Track?0');
                           }}>添加跟进</Button></strong>} />
              <WhiteSpace size='md' />
              <div>辽宁省沈阳市浑南区/负责人：业务员</div>
              <WhiteSpace size='md' />
      ...
      <Card.Body style={{ backgroundColor: '#fff', marginTop: 8 }}>
        <Tabs className='swiper-demo2' lazy={true}>
          <TabPanel tabKey='1' tab={<span className='tab_point'>动态</span>}>
            <List>
              <Item extra='2021-10-1 10:30' wrap align='top' thumb={<Avatar icon={<UserOutlined size={64} />} />}
                    multipleLine>
          ...
          <TabPanel tabKey='2' tab={<span className='tab_point'>跟进</span>}>
            <List>
              <Item extra='2021-10-1 10:30' align='top' wrap thumb={<Avatar icon={<UserOutlined size={64} />} />}
                    multipleLine>
