...
import { Button, Card, Input, List, Radio, Space, TextArea, Toast } from 'antd-mobile';
...
const CreateInStock = (props) => {
  ...
  return <>
    ...
    >
      ...
      <Card title={<div>基本信息</div>} style={{ padding: 0 }} headerStyle={{ background: '#eee', paddingLeft: 8 }}>
