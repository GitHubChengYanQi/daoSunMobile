...
const QualityPlan = (
  ...
  return <div style={{overflowX:'hidden'}}>
    ...
    <Row gutter={24}>
      <Col span={7} style={{ backgroundColor: '#f5f5f5', padding: 0, maxHeight: '70vh', overflowY: 'auto',overflowX:'hidden' }}>
        <div>
          <SideBar
      ...
      <Col span={16} style={{ padding: 8, maxHeight: '70vh', overflowY: 'auto',overflowX:'hidden' }}>
        <div>
          <Card
