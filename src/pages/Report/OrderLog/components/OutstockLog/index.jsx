...
export const outstockLog = { url: '/outstockOrder/detail', method: 'POST' };

const OutstockLog = ({ outstockOrderId }) => {

  const { loading, data = {} } = useRequest({ ...outstockLog, data: { outstockOrderId } });
  ...
  return <>
    <MyCard title='出库明细' bodyClassName={styles.cardBody}>
      {
