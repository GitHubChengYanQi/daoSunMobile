...
const TaskStatistics = () => {
  ...
  const status = [
    { num: 87, color: '#257BDE', text: '已完成' },
    { num: 3, color: '#FA8F2B', text: '执行中' },
    { num: 5, color: '#D8D8D8', text: '已撤销' },
    { num: 5, color: '#FF3131', text: '已超期' },
  ];

  const types = [
    { num: 80, color: '#257BDE', text: '入库' },
    { num: 3, color: '#82B3EA', text: '出库' },
    { num: 5, color: '#2EAF5D', text: '盘点' },
    { num: 2, color: '#FA8F2B', text: '养护' },
    { num: 10, color: '#FF3131', text: '调拨' },
  ];
  ...
  return <div className={styles.card}>
    ...
    <div className={styles.taskStatisticsContent}>
      ...
      <div className={styles.flexCenter} style={{ columnGap: 24, rowGap: 8, flexWrap: 'wrap', fontSize: 12 }}>
        {status.map((item, index) => {
          return <div
